      ...
      <DialogContent className="rounded-xl mx-4">
        ...
        <div className="space-y-4">
          <div className="space-y-1.5">
            <Label>食事内容</Label>
            <Input value={description} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setDescription(e.target.value)} className="rounded-xl" />
          </div>
          ...
          <div className="flex gap-2 pt-2">
            <Button variant="outline" className="flex-1 rounded-xl" onClick={onClose}>キャンセル</Button>
